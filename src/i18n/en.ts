...
export const en: TranslationKey = {
  ...
  appSubtitle: 'Secure file splitting and recovery tool based on Shamir secret sharing algorithm',
  
  // Features
  featureSecureEncryption: 'Secure Encryption',
  featureSecureEncryptionDesc: 'Strong file protection using AES-256-GCM encryption algorithm',
  featureSmartSplitting: 'Smart Splitting',
  featureSmartSplittingDesc: 'Split encryption keys into multiple shares, distributed storage improves security',
  featureFlexibleRecovery: 'Flexible Recovery',
  featureFlexibleRecoveryDesc: 'Recover original files with only partial shares, providing good fault tolerance',
  ...
  footerDescription: 'Secure file splitting and recovery using Shamir secret sharing algorithm',
  ...
  pureShamirSchemeDesc3: '• Conforms to traditional threshold encryption theory',
  splittingConfig: 'Splitting Configuration',
  totalShares: 'Total Shares (n)',
  threshold: 'Threshold (m)',
  shareDescription: 'File will be split into {totalShares} shares, any {threshold} shares can recover the file',
  ...
  passwordSecurityNote3: '• Must remember password, cannot be recovered if forgotten',
  ...
  noPasswordNote3: '• Recommend enabling password protection for enhanced security',
  pureShamirInfo: 'Pure Shamir Scheme Features:',
  pureShamirInfoDesc1: '• Directly split file data, no additional encrypted file needed',
  pureShamirInfoDesc2: '• Conforms to traditional threshold secret sharing theory',
  pureShamirInfoDesc3: '• Optional password protection available',
  pureShamirInfoDesc4: '• Anyone with sufficient shares{usePassword} can recover the file',
  startEncryption: 'Start Encryption',
  encrypting: 'Encrypting...',
  encryptionComplete: 'Encryption Complete!',
  encryptionCompleteDesc1: '• File successfully encrypted and split into {totalShares} shares',
  encryptionCompleteDesc2: '• Need encrypted file + any {threshold} shares to recover original file',
  encryptionCompleteDesc3: '• Please download all files and store them securely',
  fileSplittingComplete: 'File Splitting Complete!',
  fileSplittingCompleteDesc1: '• File directly split into {totalShares} shares',
  fileSplittingCompleteDesc2: '• Only need any {threshold} shares to recover original file',
  ...
  recordSHA256Note: '💡 Please record this SHA256 value for manual file integrity verification during recovery.',
  ...
  hybridSchemeRecoveryDesc: 'Need encrypted file and sufficient share files to recover original file',
  pureShamirRecoveryDesc: 'Only need sufficient share files{needsPassword} to recover original file, no encrypted file needed',
  selectShareFiles: 'Select Share Files',
  pureShamirUploadNote: 'Pure Shamir scheme needs sufficient share files (usually threshold number)',
  selectedShareFiles: 'Selected Share Files:',
  filesCount: '{count} files',
  pureShamirTip: '💡 Tip: Pure Shamir scheme usually needs same number of shares as threshold',
  pureShamirTipDesc: 'If recovery fails, try uploading more different share files',
  ...
  pureShamirPasswordNote: '• Pure Shamir scheme: password and shares jointly protect file security',
  ...
  fileRecoveredNote: 'File successfully recovered. If you have the original file SHA256 value, you can manually verify file integrity above.',
  ...
  sha256VerificationPass: '✅ SHA256 verification passed: File integrity confirmed',
  sha256VerificationFail: '❌ SHA256 verification failed: File may be corrupted or tampered',
